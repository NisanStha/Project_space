...
void main()
{
    ...
    struct object enemy[51];
    struct object phantom_left;
    struct object phantom_right;
    init_struct_enemy(enemy,&phantom_left,&phantom_right);
...
void init_struct_enemy(struct object enemy[],struct object *phantom_left,struct object *phantom_right)
{
    int c,i=3,j=3;
    for (c=1;c<=50;c++)
    {
